...
#    Updated: 2022/09/17 21:16:53 by ommohame         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC			=	builtins/env.c \
				...
				history/utils.c \
				history/get_next_line.c \
				history/get_next_line_utils.c \
				redirection/redirection_engine.c \
				redirection/redirection_in.c \
				redirection/redirection_out.c \
				redirection/manipulate_fds.c \
				signals/signals.c \
				pipe/pipe.c \
				...
				$(DIR_PARSER)fake_string/fake_string.c $(DIR_PARSER)fake_string/utils.c\
